...
import {TMDB_API_KEY, TMDB_API_URL} from "../api";
        ...
        >
            <Col>
                ...
                <Items>
                    <Item>
                        <Link to={"/"}>
                            Home {isHomeMatch && <Circle layoutId="circle"/>}
                        </Link>
                    </Item>
                    <Item>
                        <Link to={"/tv"}>
                            Tv Shows {isTvMatch && <Circle layoutId="circle"/>}
                        </Link>
                    </Item>
                </Items>
            </Col>
            <Col>
                <Search>
                    ...
                    <Input animate={inputAnimation}
                           initial={{scaleX: 0}}
                           transition={{type: "linear"}}
                           placeholder="Search for movie or th show."
                    />
                </Search>
            </Col>
        </Nav>
